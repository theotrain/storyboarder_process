...
function createImage(x, y, high, wide, imgURL, count) {
  ...
  sprite.draw = function() {
    ...
    $('#main').append('<div class="dragImage" class="'this.classNum'" style="top:' + this.topPos +'px; left:'+ this.leftPos +'px;"><div id="absPos" class="resizeImage" class="'this.classNum'" style="height:' + this.high +'px; width:'+ this.wide +'px;"><img class="innerImg'+ this.classNum +'" src="' + this.resource + '" /></div></div>');
